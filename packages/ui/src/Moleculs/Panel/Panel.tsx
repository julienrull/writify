...
export const Panel = ({
  ...
  const panelElement: React.RefObject<HTMLTableSectionElement> =
  ...
  return (
    <section
      className={
        direction === "horizontal"
          ? styles.panel + " " + styles["panel-horizontal"]
          : styles.panel + " " + styles["panel-vertical"]
      }
      ref={panelElement}
    >
